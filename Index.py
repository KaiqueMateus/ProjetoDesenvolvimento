...
def clique_agenda():
    mostrar_pagina_agenda(janela)  # Chamar a função para mostrar a página do cliente
...
def configure_frame_esquerda(parent):
    ...
    titulo = ctk.CTkLabel(frame, text="SOS", font=("Chonburi", 122), text_color="white")
    titulo.pack(padx=10, pady=(10, 5))

    subtitulo = ctk.CTkLabel(frame, text="Cadastrar", font=("Inria Sans", 32), text_color="white")
    subtitulo.pack(padx=10, pady=(5, 5), anchor="w")
    ...
    funcionario = ctk.CTkButton(
        frame, text="FUNCIONÁRIO", command=clique, width=350, height=50, 
        fg_color="#ff6347", hover_color="lightpink",
        text_color="white", border_color="white", border_width=2,
        font=("Arial", 25, "bold")
    )
    funcionario.pack(padx=10, pady=10)
    
    cliente = ctk.CTkButton(
        frame, text="CLIENTE", command=clique_agenda, width=350, height=50, 
        fg_color="#ff6347", hover_color="lightpink",
        text_color="white", border_color="white", border_width=2,
        font=("Arial", 25, "bold")
    )
    ...
    def on_enter_funcionario(event):
     funcionario.configure(fg_color="#ff6347", text_color="darkred")

    def on_leave_funcionario(event):
     funcionario.configure(fg_color="#ff6347", text_color="white")

    def on_enter_cliente(event):
     cliente.configure(fg_color="#ff6347", text_color="darkred")

    def on_leave_cliente(event):
     cliente.configure(fg_color="#ff6347", text_color="white")
    ...
    subtitulo2 = ctk.CTkLabel(frame, text="Procedimentos", font=("Inria Sans", 32), text_color="white")
    subtitulo2.pack(padx=10, pady=(5, 5),  anchor="w")
    ...
    def on_enter_unha(event):
     unha.configure(fg_color="#ff6347", text_color="darkred")

    def on_leave_unha(event):
     unha.configure(fg_color="#ff6347", text_color="white")
    ...
    def on_enter_cabelo(event):
     cabelo.configure(fg_color="#ff6347", text_color="darkred")

    def on_leave_cabelo(event):
     cabelo.configure(fg_color="#ff6347", text_color="white")
    ...
    def on_enter_sobrancelha(event):
     sobrancelha.configure(fg_color="#ff6347", text_color="darkred")

    def on_leave_sobrancelha(event):
     sobrancelha.configure(fg_color="#ff6347", text_color="white")

    sobrancelha.bind("<Enter>", on_enter_sobrancelha)
    sobrancelha.bind("<Leave>", on_leave_sobrancelha)

    subtitulo3 = ctk.CTkLabel(frame, text="Atendimento", font=("Inria Sans", 32), text_color="white")
    subtitulo3.pack(padx=10, pady=(5, 5),  anchor="w")

    linha = ctk.CTkFrame(frame, height=2, width=300, fg_color="white")
    linha.pack(padx=10, pady=(5, 20))

    agendar = ctk.CTkButton(
        frame, text="AGENDAR",  command=clique_agenda, width=350, height=50, 
        fg_color="#ff6347", hover_color="lightpink",
        text_color="white", border_color="white", border_width=2,
        font=("Arial", 25, "bold")
    )
    ...
    def on_enter_agendar(event):
     agendar.configure(fg_color="#ff6347", text_color="darkred")

    def on_leave_agendar(event):
     agendar.configure(fg_color="#ff6347", text_color="white")
...
def configure_frame_direita(parent):
    ...
    texto_direita = ctk.CTkLabel(frame, text="CADASTRO DE FUNCIONÁRIOS", font=("Inria Sans", 32), text_color="white")
    texto_direita.pack(padx=10, pady=10,  anchor="w")

    subtitulo2 = ctk.CTkLabel(frame, text="Dados Pessoais", text_color="red", font=("Inria Sans", 32))
    subtitulo2.pack(padx=10, pady=(5, 5),  anchor="w")

    linha2 = ctk.CTkFrame(frame, height=2, width=720, fg_color="red")
    linha2.pack(padx=10, pady=(5, 20),  anchor="w")
    ...
    # Linha 1
    label_nome = ctk.CTkLabel(frame_dados_pessoais, text="Nome:", font=("Inria Sans", 32), text_color="white")
    ...
    label_email = ctk.CTkLabel(frame_dados_pessoais, text="E-mail:", font=("Inria Sans", 32), text_color="white")
    ...
    # Linha 2
    label_telefone = ctk.CTkLabel(frame_dados_pessoais, text="Telefone:", font=("Inria Sans", 32), text_color="white")
    ...
    label_sexo = ctk.CTkLabel(frame_dados_pessoais, text="Sexo:", font=("Inria Sans", 32), text_color="white")
    ...
    # Linha 3
    label_cpf = ctk.CTkLabel(frame_dados_pessoais, text="CPF:", font=("Inria Sans", 32), text_color="white")
    ...
    label_data_nascimento = ctk.CTkLabel(frame_dados_pessoais, text="Data de Nascimento:", font=("Inria Sans", 32), text_color="white")
    ...
    subtitulo3 = ctk.CTkLabel(frame, text="Endereço", text_color="red", font=("Inria Sans", 32))
    subtitulo3.pack(padx=10, pady=(5, 5),  anchor="w")

    linha4 = ctk.CTkFrame(frame, height=2, width=720, fg_color="red")
    linha4.pack(padx=10, pady=(5, 20),  anchor="w")
    ...
    # Linha 1 (Endereço)
    label_CEP = ctk.CTkLabel(frame_endereco, text="CEP:", font=("Inria Sans", 32), text_color="white")
    ...
    entry_CEP.grid(row=0, column=1, padx=10, pady=5, sticky="w")
    buttonConsultaCEP = ctk.CTkButton(
        frame_endereco, text="Consultar CEP", command=clique_CEP, width=130, height=30, 
        fg_color="blue", hover_color="black",
        text_color="white", corner_radius=10, border_width=2,
        font=("Arial", 20, "bold")
    )
    buttonConsultaCEP.grid(row=0, column=2, padx=10, pady=5, sticky="w")

    label_Bairro = ctk.CTkLabel(frame_endereco, text="Bairro:", font=("Inria Sans", 32), text_color="white")
    label_Bairro.grid(row=1, column=0, padx=10, pady=5, sticky="w")
    entry_Bairro = ctk.CTkEntry(frame_endereco, fg_color="white", text_color="black", height=30, width=200)
    entry_Bairro.grid(row=1, column=1, padx=10, pady=5, sticky="e")

    # Linha 2 (Endereço)
    label_logradouro = ctk.CTkLabel(frame_endereco, text="Logradouro:", font=("Inria Sans", 32), text_color="white")
    label_logradouro.grid(row=2, column=0, padx=10, pady=5, sticky="w")
    entry_logradouro = ctk.CTkEntry(frame_endereco, fg_color="white", text_color="black", height=30, width=200)
    entry_logradouro.grid(row=2, column=1, padx=10, pady=5, sticky="e")

    label_Número = ctk.CTkLabel(frame_endereco, text="Número:", font=("Inria Sans", 32), text_color="white")
    label_Número.grid(row=2, column=2, padx=10, pady=5, sticky="w")
    entry_Número = ctk.CTkEntry(frame_endereco, fg_color="white", text_color="black", height=30, width=200)
    entry_Número.grid(row=2, column=3, padx=10, pady=5, sticky="e")


    admissao = ctk.CTkLabel(frame, text="Admissao", text_color="red", font=("Inria Sans", 32))
    admissao.pack(padx=10, pady=(5, 5),  anchor="w")
    ...
    # Linha 1
    label_data_admissao = ctk.CTkLabel(frame_admissao, text="Data de Admissão:", width=45, font=("Inria Sans", 32), text_color="white")
    ...
    label_funcao = ctk.CTkLabel(frame_admissao, text="Função:", font=("Inria Sans", 32), text_color="white")
