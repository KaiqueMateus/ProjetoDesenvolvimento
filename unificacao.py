...
entryusuario = ctk.CTkEntry(frameLogin, width=668, height=44, corner_radius=14, placeholder_text='Nome de Usuario ou Email')
...
esqueceusenha = ctk.CTkButton(frameLogin, width=235, height=30, text="Esqueceu a senha?", text_color='white', hover=False,
                              font=('regular', 15))
...
def funcionario():
    switch_frame(frameCadastroFuncionario)


def cliente():
    frameCadastroClientes.tkraise()

# Configurando o botão com as opções solicitadas
funcionario = ctk.CTkButton(
    frameEsquerda, text="FUNCIONARIO", command=funcionario, width=350, height=50,
...
cliente = ctk.CTkButton(
    frameEsquerda, text="CLIENTE", command=cliente, width=350, height=50,
    fg_color="#fa7f72", hover_color="lightpink",
    text_color="white", corner_radius=10, border_color="grey", border_width=2,
    font=("Arial", 30, "bold")
)
...
#def switch_frame(new_frame):
 #   current_frame = getattr(frameAuxiliar, "current_frame", None)
  #  if current_frame is not None:
   #new_frame.pack(fill="both", expand=True)
    #frameAuxiliar.current_frame = new_frame
######################################################################################################################
#Cadastro de clientes

frame_cor = "#fa7f72"  # Cor do frame
frameCadastroClientes = ctk.CTkFrame(frameAuxiliar, corner_radius=10, fg_color=frame_cor)
frameCadastroClientes.pack(side="left", fill="both", expand=True, padx=20, pady=20)

texto_direita = ctk.CTkLabel(frameCadastroClientes, text="CADASTRO DE CLIENTES", font=("Arial", 30), text_color="white")
texto_direita.pack(padx=10, pady=10)

subtitulo2 = ctk.CTkLabel(frameCadastroClientes, text="Dados Pessoais", text_color="red", font=("Arial", 18))
subtitulo2.pack(padx=10, pady=(5, 5))

linha2 = ctk.CTkFrame(frameCadastroClientes, height=2, width=380, fg_color="red")
linha2.pack(padx=10, pady=(5, 20))

# Labels e Entradas para os dados pessoais organizados em duas colunas
frame_dados_pessoais = ctk.CTkFrame(frameCadastroClientes, corner_radius=10, fg_color="#fa7f72")
...
subtitulo3 = ctk.CTkLabel(frameCadastroClientes, text="Endereço", text_color="red", font=("Arial", 18))
subtitulo3.pack(padx=10, pady=(5, 5))

linha4 = ctk.CTkFrame(frameCadastroClientes, height=2, width=380, fg_color="red")
linha4.pack(padx=10, pady=(5, 20))

frame_endereco = ctk.CTkFrame(frameCadastroClientes, corner_radius=10, fg_color="#fa7f72")
...
botao_cadastrar = ctk.CTkButton(frameCadastroClientes, text="Cadastrar", font=("Arial", 30), text_color="white",
                                fg_color='#DF4621')
botao_cadastrar.pack(after=frame_endereco, padx=10, pady=15, side='bottom', anchor='s')

botao_editar = ctk.CTkButton(frameCadastroClientes, text="editar cliente", font=("Arial", 30), text_color='white', fg_color='#DF4621')
botao_editar.pack(after=frame_endereco, padx=10, pady=15, side='bottom')
#######################################################################################################################
#Cadastro de funcionario

frameCadastroFuncionario = ctk.CTkFrame(frameAuxiliar, corner_radius=10, fg_color=frame_cor)
#

# Adicionando Título e Subtítulo

texto_direita = ctk.CTkLabel(frameCadastroFuncionario, text="CADASTRO DE FUNCIONÁRIOS", font=("Arial", 30),
                             text_color="white")
texto_direita.pack(padx=10, pady=10)

subtitulo2 = ctk.CTkLabel(frameCadastroFuncionario, text="Dados Pessoais", text_color="red", font=("Arial", 18))
subtitulo2.pack(padx=10, pady=(5, 5))

linha2 = ctk.CTkFrame(frameCadastroFuncionario, height=2, width=380, fg_color="red")
linha2.pack(padx=10, pady=(5, 20))
